...
export function AnalysisForm({ onSubmit, busy }: { onSubmit: (value: AnalysisRequest) => void; busy: boolean }) {
  ...
  return (
    <form className="analysis-form" onSubmit={handleSubmit(onSubmit)}>
      <div className="panel-heading">
        <span className="heading-icon violet"><FlaskConical /></span>
        <div><h2>Your product</h2><p>Product evidence and transparent unit economics.</p></div>
      </div>
      ...
      <fieldset className="risk-field">
        <legend>How bold do you feel?</legend>
