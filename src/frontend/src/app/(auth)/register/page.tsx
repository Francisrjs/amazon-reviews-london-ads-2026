...
export default function RegisterPage() {
  return <AuthShell eyebrow="Start with evidence" title="Create your Launchly account" description="No promises of overnight success—just a clearer, more defensible next move.">
